...
import type { MetadataFieldDescriptor } from "@/lib/bpm-api";
...
export type AutomationNodeMetadata = { type:string; commonFields:string[]; configFields:string[]; configFieldsMetadata?:MetadataFieldDescriptor[]; category?:string; label?:string; description?:string };
