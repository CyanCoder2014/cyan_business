...
public class PlatformAppDslDefinition {
    ...
    public void setEntities(List<EntityBlueprint> entities) { this.entities = entities; }
    public List<RouteBlueprint> getRoutes() { return routes; }
    public void setRoutes(List<RouteBlueprint> routes) { this.routes = routes; }
    public List<FlowBlueprint> getFlows() { return flows; }
    public void setFlows(List<FlowBlueprint> flows) { this.flows = flows; }
