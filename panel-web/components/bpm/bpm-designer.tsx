...
function StateInspector({ state, flow, locale, scope, update, close, remove, actionTypes, automations, setStart }: { state: FlowStateDraft; flow: DynamicFlowDefinition; locale: string; scope: { tenantKey?: string; siteKey?: string }; update: (patch: Partial<FlowStateDraft>) => void; close: () => void; remove: () => void; actionTypes: string[]; automations: AutomationFlow[]; setStart: () => void }) {
