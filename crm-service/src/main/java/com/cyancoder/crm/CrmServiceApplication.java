...
@EnableScheduling
@EntityScan(basePackages = {"com.cyancoder.crm.entity", "com.cyancoder.dynamiccore.store.jpa"})
@EnableJpaRepositories(basePackages = {"com.cyancoder.crm.repository", "com.cyancoder.dynamiccore.store.jpa"})
