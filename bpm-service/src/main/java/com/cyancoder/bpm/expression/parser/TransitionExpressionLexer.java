...
public class TransitionExpressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "LE", "GE", "EQ", 
			"NEQ", "GT", "LT", "PLUS", "MINUS", "MUL", "DIV", "AND", "OR", "NOT", 
			"RANGE_AND", "CONTAINS", "NOTCONTAINS", "BETWEEN", "IS", "NULL", "EMPTY", 
			"STARTSWITH", "ENDSWITH", "CONTAINSSTR", "MATCHES", "BOOLEAN", "NUMBER", 
	...
	public TransitionExpressionLexer(CharStream input) {
		super(input);
