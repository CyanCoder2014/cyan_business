...
export default function AutomationsPage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      if (canOperate) {
        try { setRuns(await listExecutions()); }
