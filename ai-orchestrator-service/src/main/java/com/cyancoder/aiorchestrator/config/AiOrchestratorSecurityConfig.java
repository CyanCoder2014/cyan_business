...
@EnableConfigurationProperties({InternalSecurityProperties.class, LlmProperties.class, RagProperties.class, PlatformMetadataProperties.class})
public class AiOrchestratorSecurityConfig {
