package com.cyancoder.commerce;
...
@EnableScheduling
@EntityScan(basePackages = {"com.cyancoder.commerce.entity", "com.cyancoder.dynamiccore.store.jpa"})
@EnableJpaRepositories(basePackages = {"com.cyancoder.commerce.repository", "com.cyancoder.dynamiccore.store.jpa"})
