...
@EnableScheduling
@EntityScan(basePackages = {"com.cyancoder.finance.entity", "com.cyancoder.dynamiccore.store.jpa"})
@EnableJpaRepositories(basePackages = {"com.cyancoder.finance.repository", "com.cyancoder.dynamiccore.store.jpa"})
