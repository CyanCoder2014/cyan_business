...
function MetadataFieldInput({ field, value, onChange }: { field: MetadataFieldDescriptor; value: unknown; onChange: (value: unknown) => void }) {
  const id = `action-field-${field.key}`;
