...
export default function BotSessionPage() {
  ...
  useEffect(() => { getConversationSession(sessionId).then(setSession).catch(reason => setError(describeApiError(reason, "Session could not be loaded").message)); }, [sessionId]);
