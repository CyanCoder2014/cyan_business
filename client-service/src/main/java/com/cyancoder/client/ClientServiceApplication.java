...
@EntityScan(basePackages = {"com.cyancoder.client.entity", "com.cyancoder.dynamiccore.store.jpa"})
@EnableJpaRepositories(basePackages = {"com.cyancoder.client.repository", "com.cyancoder.dynamiccore.store.jpa"})
