    ...
    public List<StateActionStructureResponse> stateActionStructures() {
        ...
        return List.of(
                ...
                new StateActionStructureResponse("RUN_AUTOMATION_BLOCK", List.of(), "Runs automation from BPM, synchronously or as a waiting async block.", commonFields, List.of(
                        ...
                        new MetadataFieldDescriptor("resultMappings", "object", false, "Alias for callbackResponseMappings/outputMappings. For sync execution it maps automation output fields.", Map.of("payload.currentFormValues.riskScore", "riskScore")),
                        ...
                        new MetadataFieldDescriptor("storeExecutionIdAt", "string", false, "Payload path to store the execution id.", "payload.automation.screening.executionId"),
                        new MetadataFieldDescriptor("storeStatusAt", "string", false, "Payload path to store execution status.", "payload.automation.screening.status"),
                        new MetadataFieldDescriptor("storeVariablesAt", "string", false, "Payload path to store automation output variables.", "payload.automation.screening.output"),
                        new MetadataFieldDescriptor("storeFullExecutionAt", "string", false, "Payload path to store full execution/start/callback data.", "payload.automation.screening.execution"),
                        new MetadataFieldDescriptor("storeErrorAt", "string", false, "Payload path to store automation error details.", "payload.automation.screening.error"),
    ...
    public TransitionConditionStructureResponse transitionConditionStructure() {
        return new TransitionConditionStructureResponse(
                ...
                List.of(
                        ...
                        new TransitionConditionOperatorDescriptor("ON_OR_BEFORE", "scalar-date", "Date is on or before value.", "2025-01-01"),
                        new TransitionConditionOperatorDescriptor("ON_OR_AFTER", "scalar-date", "Date is on or after value.", "2025-01-01"),
